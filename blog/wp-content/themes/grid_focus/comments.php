	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<div class="comment-author">
				...
				<br/><?php if ($comment->extra_twitter) {
...
<a href="http://twitter.com/<?=$extra_twitter ?>" target=_new">@<?=$extra_twitter?></a>
...
<p class="contain"><input type="text" name="twitter" id="twitter" size="22" tabindex="3" />
<label for="twitter"><small>Twitter ID </small></label></p>

<p class="contain"><input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="22" tabindex="4" />
